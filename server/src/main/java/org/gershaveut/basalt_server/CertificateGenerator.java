...
public class CertificateGenerator {
	public static final String FILE_NAME = Util.savePrefix("certificate.p12");
	
	private static final String ALIAS = "certificate";
	private static final char[] PASSWORD = ALIAS.toCharArray();
